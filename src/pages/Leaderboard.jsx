...
const Leaderboard = () => {
    ...
    return (
        <div className="w-11/12 min-h-screen mx-auto my-16 px-4">
            {/* Header Section */}
            <div className="text-center mb-12">
                <h1 className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-t from-purple-500 to-indigo-600 mb-4">
                    🏆 Hall of Fame
                </h1>
