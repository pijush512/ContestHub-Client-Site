...
const ContestDetails = () => {
  ...
  if (userLoading || loading) return <p className="text-center mt-10">Loading...</p>;
  ...
  const handleSubmitTask = () => {
    if (!taskInput) return alert("Please provide task link!");
    fetch("http://localhost:3000/participate", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
  ...
  return (
    <div className="w-11/12 mx-auto py-16">
      ...
      {!contestEnded && !registered && (
        <button onClick={handleRegister} className="btn btn-primary mb-4">
          Register / Pay
        </button>
      )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-96">
            ...
            <textarea
              ...
              placeholder="Provide your task link..."
              value={taskInput}
